            ...
            <div className='pt-16'>
                <main className="flex">
                        ...
                        <div className="p-6">
                            <div className="mb-8">
                                <div className='flex justify-between items-center mb-4'>
                                    <h2 className="text-xl font-bold bg-gradient-to-l from-[#687984] to-[#B9D7EA] text-transparent bg-clip-text">My Groups</h2>
                                    <button
                            ...
                            <div>
                                <h2 className="text-xl font-bold bg-gradient-to-l from-[#687984] to-[#B9D7EA] text-transparent bg-clip-text mb-4">Available Groups</h2>
                                <div className="space-y-4">
                    ...
                    <section className="w-3/4 ml-[25%] p-6">
                        <h1 className="text-2xl font-bold bg-gradient-to-l from-[#687984] to-[#B9D7EA] text-transparent bg-clip-text mb-6">Groups Feed</h1>
                        <div className="space-y-4">
