import { Post_type } from './utils/types/types'
...
export const dummyPosts: Post_type[] = [
	...
	},
	{
		...
		content:
			'Just completed my first month using an AI fitness tracker, and the results are incredible! The personalized workout suggestions and form corrections have made such a difference. Looking forward to reaching new fitness milestones! 💪 #FitnessJourney #AIFitness #HealthTech',
		privacy: 'PUBLIC',
		author: {
			id: 1,
			firstName: 'Alice',
	...
	},
	{
		...
		content:
			'Just wrapped up my first AI art exhibition! The blend of human creativity and machine learning created some truly unique pieces. Amazing to see how technology can enhance artistic expression rather than replace it. #AIArt #DigitalArt #Exhibition',
		privacy: 'PUBLIC',
		author: {
			id: 4,
			firstName: 'Peter',
